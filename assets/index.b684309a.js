import{d as f,u as j,a as P,r as B,b as u,c as h,e as c,f as m,w as v,p as O,g as D,o as l,F as y,h as C,t as A,i as k,n as I,j as J,k as z,l as K,m as L,q as U,s as X,v as Z,N,x as G,y as Q,R as Y}from"./vendor.50385166.js";const ee=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};ee();const ne="modulepreload",W={},te="./",_=function(n,t){return!t||t.length===0?n():Promise.all(t.map(a=>{if(a=`${te}${a}`,a in W)return;W[a]=!0;const o=a.endsWith(".css"),r=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${r}`))return;const s=document.createElement("link");if(s.rel=o?"stylesheet":ne,o||(s.as="script",s.crossOrigin=""),s.href=a,document.head.appendChild(s),o)return new Promise((i,p)=>{s.addEventListener("load",i),s.addEventListener("error",p)})})).then(()=>n())};function b(e,n=!0){const t=e.split("/").map(a=>n?encodeURIComponent(a):a);return t[0].includes(".")&&t.splice(0,1,""),t.join("/")}var w=(e,n)=>{for(const[t,a]of n)e[t]=a;return e};const oe=f({name:"layout-search-modal",mounted(){},setup(){const e=j(),n=P(),t=B({searchRes:[]});return{goPage:function(r,s){n.push(b(r)+(s||"")),e.commit("setShowSearchState",!1)},searchInput:function(r){t.searchRes=[],r&&e.state.docsData.forEach(s=>{s.name.includes(r)&&t.searchRes.push({data:s,isPageName:!0,pageName:s.name,matchHtml:`<div>${s.name.replace(r,`<span style="color: var(--main-color)">${r}</span>`)}</div>`,searchValue:r}),s.keyWords.forEach(i=>{i.indexOf(r)>=0&&t.searchRes.push({data:s,isPageName:!1,pageName:s.name,matchHtml:`<div>${i.replace(r,`<span style="color: var(--main-color)">${r}</span>`)}</div>`,searchValue:r,matchContent:i})})})},state:t}}}),F=e=>(O("data-v-4d69aae7"),e=e(),D(),e),re={class:"search-modal"},se={class:"search-input"},ae={class:"search-scroll"},ie=["onClick"],ce=["innerHTML"],pe=["onClick"],le=F(()=>c("div",{class:"search-scroll-item-left"},"#",-1)),de={class:"search-scroll-item-content"},ue=["innerHTML"],he={class:"search-scroll-item-content-heading"},me=F(()=>c("div",{class:"tips"},"\u6309 esc \u9000\u51FA",-1));function _e(e,n,t,a,o,r){const s=u("r-icon"),i=u("r-input"),p=u("r-scroll-bar");return l(),h("div",re,[c("div",se,[m(i,{size:"big",onInput:e.searchInput,autofocus:""},{prefix:v(()=>[m(s,{name:"iconicon-test7"})]),_:1},8,["onInput"])]),c("div",ae,[m(p,{class:"search-scroll-wrapper"},{default:v(()=>[c("div",null,[(l(!0),h(y,null,C(e.state.searchRes,(d,g)=>(l(),h("div",{key:g},[d.isPageName?(l(),h("div",{key:0,class:"search-scroll-item",onClick:x=>e.goPage(d.data.url.slice(1))},[m(s,{name:"iconform",size:20,class:"search-scroll-item-left"}),c("div",{innerHTML:d.matchHtml,class:"search-scroll-item-content search-scroll-item-mainText"},null,8,ce)],8,ie)):(l(),h("div",{key:1,class:"search-scroll-item",onClick:x=>e.goPage(`${d.data.url.slice(1)}`,`?p=${d.matchContent}`)},[le,c("div",de,[c("div",{innerHTML:d.matchHtml,class:"search-scroll-item-mainText"},null,8,ue),c("div",he,A(d.data.name),1)])],8,pe))]))),128))])]),_:1})]),me])}var ge=w(oe,[["render",_e],["__scopeId","data-v-4d69aae7"]]);const fe=f({name:"layout-sideBar",props:{menu:{type:Array,default:()=>[]},level:{type:Number,default:0}},setup:()=>{const e=j(),n=P(),t=function(){e.commit("setShowMenuState",!1)};return{activeRoutPath:k(()=>e.state.activeRoutPath),itemClick:a=>{a.children&&a.children.length>0||a.path&&(n.push(a.path),t())}}}}),ve={class:"layout-menu-item-name layout-menu-item-hasChildren"},ye=["onClick"];function ke(e,n,t,a,o,r){const s=u("layout-sideBar");return l(!0),h(y,null,C(e.menu,i=>(l(),h("div",{class:I([`layout-menu-item-${e.level}`]),key:i.path},[i.children&&i.children.length>0?(l(),h(y,{key:0},[c("div",ve,A(i.title),1),m(s,{menu:i.children,level:e.level+1},null,8,["menu","level"])],64)):(l(),h("div",{key:1,class:I(["layout-menu-item-name layout-menu-item-noChildren",{"layout-menu-item-active":i.path===e.activeRoutPath}]),onClick:p=>e.itemClick(i)},A(i.title),11,ye))],2))),128)}var V=w(fe,[["render",ke],["__scopeId","data-v-17158d96"]]);const be=f({name:"layout-content",setup(){const e=J(),n=P(),t=B({headingNav:[],path:e.path,moreHeading:!1}),a=function(){};return z(()=>e.path,async r=>{t.path=r;const s=sessionStorage.getItem("md-heading-map");if(s){const p=JSON.parse(s)[e.path];t.headingNav=p}}),{state:t,goHeading:function(r){n.push(t.path+"?p="+r.text)},switchHeading:a}}}),we={class:"layout-content"},xe={class:"layout-content-wrapper"},je={class:"layout-content-md"},Se={class:"layout-heading-menu-wrapper"},$e=["onClick"];function qe(e,n,t,a,o,r){const s=u("router-view"),i=u("r-scroll-bar");return l(),h("div",we,[c("div",xe,[c("div",je,[m(s)]),e.state.headingNav.length>0?(l(),K(i,{key:0,class:I(["layout-heading-menu",{"layout-heading-menu-moreHeading":e.state.moreHeading}])},{default:v(()=>[c("div",Se,[(l(!0),h(y,null,C(e.state.headingNav,(p,d)=>(l(),h("div",{key:d,class:"layout-heading-menu-item",onClick:g=>e.goHeading(p)},A(p.text),9,$e))),128))])]),_:1},8,["class"])):L("",!0)])])}var Ae=w(be,[["render",qe],["__scopeId","data-v-24cc1044"]]);const Ee=f({name:"layout-head",setup:()=>{const e=j(),n=k(()=>e.state.showMenu),t=function(){e.commit("setShowSearchState",!0)},a=function(){e.commit("setShowMenuState",!n.value)};return document.addEventListener("keydown",o=>{o.ctrlKey&&o.key=="k"&&(e.commit("setShowSearchState",!0),o.preventDefault()),o.key=="Escape"&&(e.commit("setShowSearchState",!1),o.preventDefault())}),{showSearch:t,toggleShowMenu:a}}}),S=e=>(O("data-v-61fc4e9f"),e=e(),D(),e),Me={class:"layout-head"},Pe=S(()=>c("div",{class:"project-name"},[U("RayxDoc"),c("span",{class:"hidden md:inline-block"}," - \u65B9\u4FBF\u56E2\u961F\u5FEB\u901F\u642D\u5EFA\u7684\u8F7B\u91CF\u6587\u6863\u7CFB\u7EDF")],-1)),Ce={class:"head-right"},Ie=S(()=>c("span",{class:"head-right-search-text"},"Search",-1)),Re=S(()=>c("span",null,null,-1)),He=S(()=>c("span",null,null,-1)),Be=S(()=>c("span",null,null,-1)),Oe=[Re,He,Be];function De(e,n,t,a,o,r){const s=u("r-icon");return l(),h("div",Me,[Pe,c("div",Ce,[c("div",{class:"head-right-search",onClick:n[0]||(n[0]=(...i)=>e.showSearch&&e.showSearch(...i))},[m(s,{name:"iconicon-test7",class:"demo-icon"}),Ie]),c("div",{class:"head-right-sidebar",onClick:n[1]||(n[1]=(...i)=>e.toggleShowMenu&&e.toggleShowMenu(...i))},Oe)])])}var Le=w(Ee,[["render",De],["__scopeId","data-v-61fc4e9f"]]);const Ne=f({name:"Layout",components:{SideBar:V,Content:Ae,Head:Le},setup(){const e=j();return{menu:k(()=>e.state.menu)}}}),We={class:"layout-menu-wrapper"};function Fe(e,n,t,a,o,r){const s=u("Head"),i=u("SideBar"),p=u("r-scroll-bar"),d=u("Content");return l(),h(y,null,[m(s),m(p,{class:"layout-menu"},{default:v(()=>[c("div",We,[m(i,{menu:e.menu},null,8,["menu"])])]),_:1}),m(d)],64)}var Ve=w(Ne,[["render",Fe],["__scopeId","data-v-915cf426"]]);const Te=f({name:"App",components:{Layout:Ve,searchModal:ge,SideBar:V},mounted(){},setup(){const e=j(),n=function(){e.commit("setShowSearchState",!1)},t=function(){e.commit("setShowMenuState",!1)};return{showSearch:k(()=>e.state.showSearch),showMenu:k(()=>e.state.showMenu),menu:k(()=>e.state.menu),clickSearchModalMask:n,closeMenu:t}}}),Je={key:0,class:"block lg:hidden fixed z-50 right-0 left-0 top-0 bottom-0 w-full h-full"};function ze(e,n,t,a,o,r){const s=u("Layout"),i=u("searchModal"),p=u("r-modal"),d=u("SideBar"),g=u("r-scroll-bar");return l(),h(y,null,[m(s),m(p,{class:"search-overlayer",show:e.showSearch,"onUpdate:show":n[0]||(n[0]=x=>e.showSearch=x),onClickMask:e.clickSearchModalMask,bodyOverflow:!1},{default:v(()=>[m(i)]),_:1},8,["show","onClickMask"]),e.showMenu?(l(),h("div",Je,[c("div",{class:"relative left-0 top-0 right-0 bottom-0 w-full h-full",onClick:n[1]||(n[1]=(...x)=>e.closeMenu&&e.closeMenu(...x))}),m(g,{class:"fixed right-0 top-[3.8rem] bottom-0 bg-white shadow-sm"},{default:v(()=>[m(d,{menu:e.menu},null,8,["menu"])]),_:1})])):L("",!0)],64)}var Ke=w(Te,[["render",ze]]),T={weight:{"\u6307\u5357/\u4ECB\u7ECD":99999,"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B":99998,\u6307\u5357:99999},defaultPage:"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md"};const E=[];let $=E,q=null;function Ue(e,n){if(e.length>0)for(let t=0;t<e.length;t++){const a=e[t];if(a.title===n)return a}return null}function Xe(e){const n=e.replace("/docs/","").split("/");n.splice(n.length-1,1,n[n.length-1].split(".").slice(0,-1).join("."));for(let t=0;t<n.length;t++){const a=n[t],o=Ue($,a);if(!o){const r=q?[...q.link,a]:[a],s={title:a,link:r,weight:T.weight[r.join("/")]||0};$.push(s),t<n.length-1&&(s.children=[],$=s.children,q=s),t===n.length-1&&(s.path=b(e));continue}o&&t<n.length-1&&(o.children||(o.children=[]),$=o.children,q=o)}return $=E,q=null,n}function Ze(e,n){let t=[{path:"/",redirect:b(`../docs/${T.defaultPage}`)}];for(const o in e){const r=Xe(b(o,!1));t.push({path:b(o),component:()=>new Promise((s,i)=>{e[o]().then(p=>{s(p.default);const d=sessionStorage.getItem("md-heading-map"),g=d?JSON.parse(d):{};g[b(o)]=p.headings,sessionStorage.setItem("md-heading-map",JSON.stringify(g))})}),meta:{menuPath:r.length>0?r.join(","):r[0]}}),n&&Array.isArray(n)&&n.length>0&&(t=[...t,...n])}const a=function(o){o.forEach(r=>{r.children&&a(r.children)}),o.sort((r,s)=>s.weight-r.weight)};return a(E),{Router:X({history:Z(),routes:t,scrollBehavior(o,r,s){return console.log(o.query),{el:`#${o.query.p}`,top:70}}}),routes:t,menu:E}}var Ge=[{name:"electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE",content:`<p><img src="./electron.jpg" alt="\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE"></p>
