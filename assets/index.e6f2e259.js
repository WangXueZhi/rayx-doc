import{d as f,u as j,a as M,r as O,c as u,b as i,e as h,w as v,p as C,f as I,g as m,o as p,F as y,h as R,t as q,i as k,n as D,j as J,k as z,l as U,m as L,q as K,s as X,v as Z,N,x as G,y as Q,R as Y}from"./vendor.d045623f.js";const ee=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerpolicy&&(s.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?s.credentials="include":t.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(t){if(t.ep)return;t.ep=!0;const s=o(t);fetch(t.href,s)}};ee();const ne="modulepreload",W={},te="./",_=function(n,o){return!o||o.length===0?n():Promise.all(o.map(a=>{if(a=`${te}${a}`,a in W)return;W[a]=!0;const t=a.endsWith(".css"),s=t?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${s}`))return;const r=document.createElement("link");if(r.rel=t?"stylesheet":ne,t||(r.as="script",r.crossOrigin=""),r.href=a,document.head.appendChild(r),t)return new Promise((c,l)=>{r.addEventListener("load",c),r.addEventListener("error",l)})})).then(()=>n())};function b(e,n=!0){const o=e.split("/").map(a=>n?encodeURIComponent(a):a);return o[0].includes(".")&&o.splice(0,1,""),o.join("/")}var w=(e,n)=>{const o=e.__vccOpts||e;for(const[a,t]of n)o[a]=t;return o};const oe=f({name:"layout-search-modal",mounted(){},setup(){const e=j(),n=M(),o=O({searchRes:[]});return{goPage:function(s,r){n.push(b(s)+(r?`/${encodeURIComponent(r)}`:"")),e.commit("setShowSearchState",!1)},searchInput:function(s){o.searchRes=[],s&&e.state.docsData.forEach(r=>{r.name.includes(s)&&o.searchRes.push({data:r,isPageName:!0,pageName:r.name,matchHtml:`<div>${r.name.replace(s,`<span style="color: var(--main-color)">${s}</span>`)}</div>`,searchValue:s}),r.keyWords.forEach(c=>{c.indexOf(s)>=0&&o.searchRes.push({data:r,isPageName:!1,pageName:r.name,matchHtml:`<div>${c.replace(s,`<span style="color: var(--main-color)">${s}</span>`)}</div>`,searchValue:s,matchContent:c})})})},state:o}}}),F=e=>(C("data-v-222d95d4"),e=e(),I(),e),re={class:"search-modal"},se={class:"search-input"},ae={class:"search-scroll"},ce=["onClick"],ie=["innerHTML"],le=["onClick"],pe=F(()=>i("div",{class:"search-scroll-item-left"},"#",-1)),de={class:"search-scroll-item-content"},ue=["innerHTML"],he={class:"search-scroll-item-content-heading"},me=F(()=>i("div",{class:"tips"},"\u6309 esc \u9000\u51FA",-1));function _e(e,n,o,a,t,s){const r=m("r-icon"),c=m("r-input"),l=m("r-scroll-bar");return p(),u("div",re,[i("div",se,[h(c,{size:"big",onInput:e.searchInput,autofocus:""},{prefix:v(()=>[h(r,{name:"iconicon-test7"})]),_:1},8,["onInput"])]),i("div",ae,[h(l,{class:"search-scroll-wrapper"},{default:v(()=>[i("div",null,[(p(!0),u(y,null,R(e.state.searchRes,(d,g)=>(p(),u("div",{key:g},[d.isPageName?(p(),u("div",{key:0,class:"search-scroll-item",onClick:x=>e.goPage(d.data.url.slice(1))},[h(r,{name:"iconform",size:20,class:"search-scroll-item-left"}),i("div",{innerHTML:d.matchHtml,class:"search-scroll-item-content search-scroll-item-mainText"},null,8,ie)],8,ce)):(p(),u("div",{key:1,class:"search-scroll-item",onClick:x=>e.goPage(`${d.data.url.slice(1)}`,d.matchContent)},[pe,i("div",de,[i("div",{innerHTML:d.matchHtml,class:"search-scroll-item-mainText"},null,8,ue),i("div",he,q(d.data.name),1)])],8,le))]))),128))])]),_:1})]),me])}var ge=w(oe,[["render",_e],["__scopeId","data-v-222d95d4"]]);const fe=f({name:"layout-sideBar",props:{menu:{type:Array,default:()=>[]},level:{type:Number,default:0}},setup:()=>{const e=j(),n=M(),o=function(){e.commit("setShowMenuState",!1)};return{activeRoutPath:k(()=>e.state.activeRoutPath),itemClick:a=>{a.children&&a.children.length>0||a.path&&(n.push(a.path),o())}}}}),ve={class:"layout-menu-item-name layout-menu-item-hasChildren"},ye=["onClick"];function ke(e,n,o,a,t,s){const r=m("layout-sideBar");return p(!0),u(y,null,R(e.menu,c=>(p(),u("div",{class:D([`layout-menu-item-${e.level}`]),key:c.path},[c.children&&c.children.length>0?(p(),u(y,{key:0},[i("div",ve,q(c.title),1),h(r,{menu:c.children,level:e.level+1},null,8,["menu","level"])],64)):(p(),u("div",{key:1,class:D(["layout-menu-item-name layout-menu-item-noChildren",{"layout-menu-item-active":c.path===e.activeRoutPath}]),onClick:l=>e.itemClick(c)},q(c.title),11,ye))],2))),128)}var V=w(fe,[["render",ke],["__scopeId","data-v-17158d96"]]);const be=f({name:"layout-content",setup(){const e=J(),n=M(),o=O({headingNav:[],path:e.path});return z(()=>e.path,async t=>{let s=e.path;if(e.params.id){const c=e.path.split("/");s=c.slice(0,c.length-1).join("/")}o.path=s;const r=sessionStorage.getItem("md-heading-map");if(r){const l=JSON.parse(r)[s];o.headingNav=l}}),{state:o,goHeading:function(t){n.push(o.path+"/"+encodeURIComponent(t.text))}}}}),we=e=>(C("data-v-f18aca80"),e=e(),I(),e),xe={class:"layout-content"},je={class:"layout-content-wrapper"},Se={class:"layout-content-md"},$e=we(()=>i("div",{class:"layout-content-right"},null,-1)),Ae={class:"layout-heading-menu-wrapper"},qe=["onClick"];function Ee(e,n,o,a,t,s){const r=m("router-view"),c=m("r-scroll-bar");return p(),u("div",xe,[i("div",je,[i("div",Se,[h(r)]),$e]),e.state.headingNav.length>0?(p(),U(c,{key:0,class:"layout-heading-menu"},{default:v(()=>[i("div",Ae,[(p(!0),u(y,null,R(e.state.headingNav,(l,d)=>(p(),u("div",{key:d,class:"layout-heading-menu-item",onClick:g=>e.goHeading(l)},q(l.text),9,qe))),128))])]),_:1})):L("",!0)])}var Pe=w(be,[["render",Ee],["__scopeId","data-v-f18aca80"]]);const Me=f({name:"layout-head",setup:()=>{const e=j(),n=k(()=>e.state.showMenu),o=function(){e.commit("setShowSearchState",!0)},a=function(){e.commit("setShowMenuState",!n.value)};return document.addEventListener("keydown",t=>{t.ctrlKey&&t.key=="k"&&(e.commit("setShowSearchState",!0),t.preventDefault()),t.key=="Escape"&&(e.commit("setShowSearchState",!1),t.preventDefault())}),{showSearch:o,toggleShowMenu:a}}}),S=e=>(C("data-v-2b795588"),e=e(),I(),e),Ce={class:"layout-head"},Ie=S(()=>i("div",{class:"project-name"},[K("RayxDoc"),i("span",{class:"hidden md:inline-block"}," - \u65B9\u4FBF\u56E2\u961F\u5FEB\u901F\u642D\u5EFA\u7684\u8F7B\u91CF\u6587\u6863\u7CFB\u7EDF")],-1)),Re={class:"head-right"},Be=S(()=>i("span",{class:"head-right-search-text"},"Search",-1)),He=S(()=>i("span",null,null,-1)),Oe=S(()=>i("span",null,null,-1)),De=S(()=>i("span",null,null,-1)),Le=[He,Oe,De];function Ne(e,n,o,a,t,s){const r=m("r-icon");return p(),u("div",Ce,[Ie,i("div",Re,[i("div",{class:"head-right-search",onClick:n[0]||(n[0]=(...c)=>e.showSearch&&e.showSearch(...c))},[h(r,{name:"iconicon-test7",class:"demo-icon"}),Be]),i("div",{class:"head-right-sidebar",onClick:n[1]||(n[1]=(...c)=>e.toggleShowMenu&&e.toggleShowMenu(...c))},Le)])])}var We=w(Me,[["render",Ne],["__scopeId","data-v-2b795588"]]);const Fe=f({name:"Layout",components:{SideBar:V,Content:Pe,Head:We},setup(){const e=j();return{menu:k(()=>e.state.menu)}}}),Ve={class:"layout-menu-wrapper"};function Te(e,n,o,a,t,s){const r=m("Head"),c=m("SideBar"),l=m("r-scroll-bar"),d=m("Content");return p(),u(y,null,[h(r),h(l,{class:"layout-menu"},{default:v(()=>[i("div",Ve,[h(c,{menu:e.menu},null,8,["menu"])])]),_:1}),h(d)],64)}var Je=w(Fe,[["render",Te],["__scopeId","data-v-915cf426"]]);const ze=f({name:"App",components:{Layout:Je,searchModal:ge,SideBar:V},mounted(){},setup(){const e=j(),n=function(){e.commit("setShowSearchState",!1)},o=function(){e.commit("setShowMenuState",!1)};return{showSearch:k(()=>e.state.showSearch),showMenu:k(()=>e.state.showMenu),menu:k(()=>e.state.menu),clickSearchModalMask:n,closeMenu:o}}}),Ue={key:0,class:"block lg:hidden fixed z-50 right-0 left-0 top-0 bottom-0 w-full h-full"};function Ke(e,n,o,a,t,s){const r=m("Layout"),c=m("searchModal"),l=m("r-modal"),d=m("SideBar"),g=m("r-scroll-bar");return p(),u(y,null,[h(r),h(l,{class:"search-overlayer",show:e.showSearch,"onUpdate:show":n[0]||(n[0]=x=>e.showSearch=x),onClickMask:e.clickSearchModalMask,bodyOverflow:!1},{default:v(()=>[h(c)]),_:1},8,["show","onClickMask"]),e.showMenu?(p(),u("div",Ue,[i("div",{class:"relative left-0 top-0 right-0 bottom-0 w-full h-full",onClick:n[1]||(n[1]=(...x)=>e.closeMenu&&e.closeMenu(...x))}),h(g,{class:"fixed right-0 top-[3.8rem] bottom-0 bg-white shadow-sm"},{default:v(()=>[h(d,{menu:e.menu},null,8,["menu"])]),_:1})])):L("",!0)],64)}var Xe=w(ze,[["render",Ke]]),T={weight:{"\u6307\u5357/\u4ECB\u7ECD":99999,"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B":99998,\u6307\u5357:99999},defaultPage:"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md"};const E=[];let $=E,A=null;function Ze(e,n){if(e.length>0)for(let o=0;o<e.length;o++){const a=e[o];if(a.title===n)return a}return null}function Ge(e){const n=e.replace("/docs/","").split("/");n.splice(n.length-1,1,n[n.length-1].split(".").slice(0,-1).join("."));for(let o=0;o<n.length;o++){const a=n[o],t=Ze($,a);if(!t){const s=A?[...A.link,a]:[a],r={title:a,link:s,weight:T.weight[s.join("/")]||0};$.push(r),o<n.length-1&&(r.children=[],$=r.children,A=r),o===n.length-1&&(r.path=b(e));continue}t&&o<n.length-1&&(t.children||(t.children=[]),$=t.children,A=t)}return $=E,A=null,n}function Qe(e,n){let o=[{path:"/",redirect:b(`../docs/${T.defaultPage}`)}];console.log(e);for(const t in e){const s=Ge(b(t,!1));o.push({path:b(t)+"/:id?",component:()=>new Promise((r,c)=>{e[t]().then(l=>{console.log(l),r(l.default);const d=sessionStorage.getItem("md-heading-map"),g=d?JSON.parse(d):{};g[b(t)]=l.headings,sessionStorage.setItem("md-heading-map",JSON.stringify(g))})}),meta:{menuPath:s.length>0?s.join(","):s[0]}}),n&&Array.isArray(n)&&n.length>0&&(o=[...o,...n])}const a=function(t){t.forEach(s=>{s.children&&a(s.children)}),t.sort((s,r)=>r.weight-s.weight)};return a(E),{Router:X({history:Z(),routes:o,scrollBehavior(t,s,r){return{el:`#${t.params.id}`,top:70,behavior:"smooth"}}}),routes:o,menu:E}}var Ye=[{name:"electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE",content:`<p><img src="./electron.jpg" alt="\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE"></p>
...
`,url:"./docs/\u6570\u636E\u7ED3\u6784\u548C\u7B97\u6CD5/\u52A8\u6001\u89C4\u5212.md",keyWords:["\u52A8\u6001\u89C4\u5212","\u4EC0\u4E48\u662F\u52A8\u6001\u89C4\u5212\u5462\uFF1F","\u52A8\u6001\u89C4\u5212\u95EE\u9898\u7684\u7279\u5F81","\u91CD\u53E0\u5B50\u95EE\u9898","\u6700\u4F18\u5B50\u7ED3\u6784","\u72B6\u6001\u8F6C\u79FB\u65B9\u7A0B","\u52A8\u6001\u89C4\u5212\u7684\u89E3\u9898\u601D\u60F3","\u91CD\u53E0\u5B50\u95EE\u9898\u4E3E\u4F8B - \u6590\u6CE2\u90A3\u5951\u6570\u5217","\u6700\u4F18\u5B50\u7ED3\u6784 - \u51D1\u96F6\u94B1"]}];const en={"../docs/Electron/electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE.md":()=>_(()=>import("./electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE.ce22a116.js"),["assets/electron项目基本架构图.ce22a116.js","assets/vendor.d045623f.js"]),"../docs/Linux/\u5B9A\u65F6\u66F4\u65B0svn.md":()=>_(()=>import("./\u5B9A\u65F6\u66F4\u65B0svn.bfd98f1f.js"),["assets/定时更新svn.bfd98f1f.js","assets/vendor.d045623f.js"]),"../docs/Node/mock\u670D\u52A1.md":()=>_(()=>import("./mock\u670D\u52A1.cd39b2e1.js"),["assets/mock服务.cd39b2e1.js","assets/vendor.d045623f.js"]),"../docs/Node/pnpm.md":()=>_(()=>import("./pnpm.a67af5f2.js"),["assets/pnpm.a67af5f2.js","assets/vendor.d045623f.js"]),"../docs/\u6253\u5305\u5DE5\u5177/vite.md":()=>_(()=>import("./vite.5c8a9acb.js"),["assets/vite.5c8a9acb.js","assets/vendor.d045623f.js"]),"../docs/\u6307\u5357/Mermaid.md":()=>_(()=>import("./Mermaid.6c7365c4.js"),["assets/Mermaid.6c7365c4.js","assets/vendor.d045623f.js"]),"../docs/\u6307\u5357/\u4ECB\u7ECD.md":()=>_(()=>import("./\u4ECB\u7ECD.03031ee9.js"),["assets/介绍.03031ee9.js","assets/vendor.d045623f.js"]),"../docs/\u6307\u5357/\u56FE\u7247\u8D44\u6E90.md":()=>_(()=>import("./\u56FE\u7247\u8D44\u6E90.08982990.js"),["assets/图片资源.08982990.js","assets/vendor.d045623f.js"]),"../docs/\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md":()=>_(()=>import("./\u5FEB\u901F\u4E0A\u624B.7522cbe2.js"),["assets/快速上手.7522cbe2.js","assets/vendor.d045623f.js"]),"../docs/\u6307\u5357/\u83DC\u5355\u987A\u5E8F\u63A7\u5236.md":()=>_(()=>import("./\u83DC\u5355\u987A\u5E8F\u63A7\u5236.b15b6600.js"),["assets/菜单顺序控制.b15b6600.js","assets/vendor.d045623f.js"]),"../docs/\u6570\u636E\u7ED3\u6784\u548C\u7B97\u6CD5/\u52A8\u6001\u89C4\u5212.md":()=>_(()=>import("./\u52A8\u6001\u89C4\u5212.48e0a6d9.js"),["assets/动态规划.48e0a6d9.js","assets/vendor.d045623f.js"]),"../docs/\u6253\u5305\u5DE5\u5177/webpack/require.context.md":()=>_(()=>import("./require.context.8d151309.js"),["assets/require.context.8d151309.js","assets/vendor.d045623f.js"])},{Router:B,routes:on,menu:nn}=Qe(en);B.beforeEach((e,n,o)=>{N.start(),H.commit("setActiveDocPath",e.meta.menuPath),H.commit("setActiveRoutPath",e.path),o()});B.afterEach(()=>{N.done()});const H=G({state(){return{menu:nn,activeDocPath:"",docsData:Ye,showSearch:!1,showMenu:!1,activeRoutPath:""}},mutations:{setActiveDocPath(e,n){e.activeDocPath=n},setShowSearchState(e,n){e.showSearch=n},setActiveRoutPath(e,n){e.activeRoutPath=n},setShowMenuState(e,n){e.showMenu=n}}}),P=Q(Xe);P.use(Y);P.use(B);P.use(H);P.mount("#app");export{_};
