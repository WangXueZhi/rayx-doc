import{_ as r}from"./index.8c3acdd8.js";import{d as h,y as d}from"./vendor.5022afda.js";const i=h({name:"Markdown"}),c=()=>d("div",{class:["md2vue-wrapper"],innerHTML:`<h1 id="Mermaid">Mermaid</h1><p>Mermaid\u662F\u4E00\u79CD\u7F16\u5199\u7518\u7279\u56FE\u3001\u6D41\u7A0B\u56FE\u3001\u987A\u5E8F\u56FE\u7B49\u5404\u79CD\u56FE\u5F62\u7684\u8BED\u6CD5\u548C\u89E3\u6790\u5E93\uFF0C\u901A\u8FC7\u8FD9\u79CD\u8BED\u6CD5\uFF0C\u6211\u4EEC\u53EF\u4EE5\u76F4\u63A5\u5728markdown\u4E2D\u7F16\u5199\u5404\u79CD\u56FE\u5F62\uFF0C\u63D2\u4EF6\u4F1A\u5BF9mermaid\u505A\u89E3\u6790\u8F93\u51FA\u3002</p>
...
<pre><code class="language-mermaid"><div class='mermaidWrapper' style="position: relative">
    ...
    Bob-->>John: Jolly good!</div>
        </div></code></pre>`});i.render=c;i.mounted=()=>{const a=function(n,t){n.initialize({theme:"forest"}),t.forEach((o,s)=>{n.render("mermaid"+s,o.innerText,l=>{o.innerHTML=l,o.style.opacity=1,o.parentNode.removeChild(o.parentNode.querySelector(".mermaid-loading"))})})},e=document.querySelectorAll(".mermaid");e&&e.length>0&&(window._mermaidLoaded&&window._mermaidModule?a(window._mermaidModule,e):r(()=>import("./mermaid.esm.min.43973d33.js"),[]).then(n=>{window._mermaidLoaded=!0,window._mermaidModule=n,a(n,e)}))};const g=[{text:"Mermaid",level:1,raw:"Mermaid"},{text:"\u4E3E\u4E2A\u6817\u5B50",level:2,raw:"\u4E3E\u4E2A\u6817\u5B50"}],u=[{code:`sequenceDiagram
    participant Alice
    participant Bob
    Alice->>John: Hello John, how are you?
    loop Healthcheck
    ...
    John-->>Alice: Great!
    John->>Bob: How about you?
    Bob-->>John: Jolly good!`,infostring:"mermaid"}];export{u as codeBlocks,i as default,g as headings};
