import{d as f,u as w,a as M,r as B,b as u,c as h,e as i,f as m,w as v,p as L,g as N,o as l,F as y,h as C,t as q,i as k,n as I,j as z,k as K,l as D,m as O,q as U,s as X,v as Z,N as W,x as G,y as Q,R as Y}from"./vendor.50385166.js";const ee=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerpolicy&&(s.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?s.credentials="include":o.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}};ee();const ne="modulepreload",F={},te="./",_=function(n,t){return!t||t.length===0?n():Promise.all(t.map(a=>{if(a=`${te}${a}`,a in F)return;F[a]=!0;const o=a.endsWith(".css"),s=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${s}`))return;const r=document.createElement("link");if(r.rel=o?"stylesheet":ne,o||(r.as="script",r.crossOrigin=""),r.href=a,document.head.appendChild(r),o)return new Promise((c,d)=>{r.addEventListener("load",c),r.addEventListener("error",d)})})).then(()=>n())};function x(e,n=!0){const t=e.split("/").map(a=>n?encodeURIComponent(a):a);return t[0].includes(".")&&t.splice(0,1,""),t.join("/")}var b=(e,n)=>{for(const[t,a]of n)e[t]=a;return e};const oe=f({name:"layout-search-modal",mounted(){},setup(){const e=w(),n=M(),t=B({searchRes:[]});return{goPage:function(s,r){n.push(x(s)+(r||"")),e.commit("setShowSearchState",!1)},searchInput:function(s){t.searchRes=[],s&&e.state.docsData.forEach(r=>{r.name.includes(s)&&t.searchRes.push({data:r,isPageName:!0,pageName:r.name,matchHtml:`<div>${r.name.replace(s,`<span style="color: var(--main-color)">${s}</span>`)}</div>`,searchValue:s}),r.keyWords.forEach(c=>{c.indexOf(s)>=0&&t.searchRes.push({data:r,isPageName:!1,pageName:r.name,matchHtml:`<div>${c.replace(s,`<span style="color: var(--main-color)">${s}</span>`)}</div>`,searchValue:s,matchContent:c})})})},state:t}}}),V=e=>(L("data-v-4d69aae7"),e=e(),N(),e),se={class:"search-modal"},re={class:"search-input"},ae={class:"search-scroll"},ce=["onClick"],ie=["innerHTML"],de=["onClick"],le=V(()=>i("div",{class:"search-scroll-item-left"},"#",-1)),pe={class:"search-scroll-item-content"},ue=["innerHTML"],he={class:"search-scroll-item-content-heading"},me=V(()=>i("div",{class:"tips"},"\u6309 esc \u9000\u51FA",-1));function _e(e,n,t,a,o,s){const r=u("r-icon"),c=u("r-input"),d=u("r-scroll-bar");return l(),h("div",se,[i("div",re,[m(c,{size:"big",onInput:e.searchInput,autofocus:""},{prefix:v(()=>[m(r,{name:"iconicon-test7"})]),_:1},8,["onInput"])]),i("div",ae,[m(d,{class:"search-scroll-wrapper"},{default:v(()=>[i("div",null,[(l(!0),h(y,null,C(e.state.searchRes,(p,g)=>(l(),h("div",{key:g},[p.isPageName?(l(),h("div",{key:0,class:"search-scroll-item",onClick:P=>e.goPage(p.data.url.slice(1))},[m(r,{name:"iconform",size:20,class:"search-scroll-item-left"}),i("div",{innerHTML:p.matchHtml,class:"search-scroll-item-content search-scroll-item-mainText"},null,8,ie)],8,ce)):(l(),h("div",{key:1,class:"search-scroll-item",onClick:P=>e.goPage(`${p.data.url.slice(1)}`,`?p=${p.matchContent}`)},[le,i("div",pe,[i("div",{innerHTML:p.matchHtml,class:"search-scroll-item-mainText"},null,8,ue),i("div",he,q(p.data.name),1)])],8,de))]))),128))])]),_:1})]),me])}var ge=b(oe,[["render",_e],["__scopeId","data-v-4d69aae7"]]);const fe=f({name:"layout-sideBar",props:{menu:{type:Array,default:()=>[]},level:{type:Number,default:0}},setup:()=>{const e=w(),n=M();return{activeRoutPath:k(()=>e.state.activeRoutPath),itemClick:t=>{t.children&&t.children.length>0||t.path&&n.push(t.path)}}}}),ve={class:"layout-menu-item-name layout-menu-item-hasChildren"},ye=["onClick"];function ke(e,n,t,a,o,s){const r=u("layout-sideBar");return l(!0),h(y,null,C(e.menu,c=>(l(),h("div",{class:I([`layout-menu-item-${e.level}`]),key:c.path},[c.children&&c.children.length>0?(l(),h(y,{key:0},[i("div",ve,q(c.title),1),m(r,{menu:c.children,level:e.level+1},null,8,["menu","level"])],64)):(l(),h("div",{key:1,class:I(["layout-menu-item-name layout-menu-item-noChildren",{"layout-menu-item-active":c.path===e.activeRoutPath}]),onClick:d=>e.itemClick(c)},q(c.title),11,ye))],2))),128)}var J=b(fe,[["render",ke],["__scopeId","data-v-91b79af8"]]);const xe=f({name:"layout-content",setup(){const e=z(),n=M(),t=B({headingNav:[],path:e.path,moreHeading:!1}),a=function(){};return K(()=>e.path,async s=>{t.path=s;const r=sessionStorage.getItem("md-heading-map");if(r){const d=JSON.parse(r)[e.path];t.headingNav=d}}),{state:t,goHeading:function(s){n.push(t.path+"?p="+s.text)},switchHeading:a}}}),be={class:"layout-content"},we={class:"layout-content-wrapper"},$e={class:"layout-content-md"},je={class:"layout-heading-menu-wrapper"},Se=["onClick"];function qe(e,n,t,a,o,s){const r=u("router-view"),c=u("r-scroll-bar");return l(),h("div",be,[i("div",we,[i("div",$e,[m(r)]),e.state.headingNav.length>0?(l(),D(c,{key:0,class:I(["layout-heading-menu",{"layout-heading-menu-moreHeading":e.state.moreHeading}])},{default:v(()=>[i("div",je,[(l(!0),h(y,null,C(e.state.headingNav,(d,p)=>(l(),h("div",{key:p,class:"layout-heading-menu-item",onClick:g=>e.goHeading(d)},q(d.text),9,Se))),128))])]),_:1},8,["class"])):O("",!0)])])}var Ee=b(xe,[["render",qe],["__scopeId","data-v-24cc1044"]]);const Ae=f({name:"layout-head",setup:()=>{const e=w(),n=k(()=>e.state.showMenu),t=function(){e.commit("setShowSearchState",!0)},a=function(){e.commit("setShowMenuState",!n.value)};return document.addEventListener("keydown",o=>{o.ctrlKey&&o.key=="k"&&(e.commit("setShowSearchState",!0),o.preventDefault()),o.key=="Escape"&&(e.commit("setShowSearchState",!1),o.preventDefault())}),{showSearch:t,toggleShowMenu:a}}}),$=e=>(L("data-v-1318df03"),e=e(),N(),e),Pe={class:"layout-head"},Me=$(()=>i("div",{class:"project-name"},[U("RayxDoc"),i("span",{class:"hidden md:inline-block"}," - \u65B9\u4FBF\u56E2\u961F\u5FEB\u901F\u642D\u5EFA\u7684\u8F7B\u91CF\u6587\u6863\u7CFB\u7EDF")],-1)),Ce={class:"head-right"},Ie=$(()=>i("span",{class:"head-right-search-text"},"Search",-1)),Re=$(()=>i("span",null,null,-1)),He=$(()=>i("span",null,null,-1)),Be=$(()=>i("span",null,null,-1)),Le=[Re,He,Be];function Ne(e,n,t,a,o,s){const r=u("r-icon");return l(),h("div",Pe,[Me,i("div",Ce,[i("div",{class:"head-right-search",onClick:n[0]||(n[0]=(...c)=>e.showSearch&&e.showSearch(...c))},[m(r,{name:"iconicon-test7",class:"demo-icon"}),Ie]),i("div",{class:"head-right-sidebar",onClick:n[1]||(n[1]=(...c)=>e.toggleShowMenu&&e.toggleShowMenu(...c))},Le)])])}var De=b(Ae,[["render",Ne],["__scopeId","data-v-1318df03"]]);const Oe=f({name:"Layout",components:{SideBar:J,Content:Ee,Head:De},setup(){const e=w();return{menu:k(()=>e.state.menu)}}}),We={class:"layout-menu-wrapper"};function Fe(e,n,t,a,o,s){const r=u("Head"),c=u("SideBar"),d=u("r-scroll-bar"),p=u("Content");return l(),h(y,null,[m(r),m(d,{class:"layout-menu"},{default:v(()=>[i("div",We,[m(c,{menu:e.menu},null,8,["menu"])])]),_:1}),m(p)],64)}var Ve=b(Oe,[["render",Fe],["__scopeId","data-v-915cf426"]]);const Je=f({name:"App",components:{Layout:Ve,searchModal:ge,SideBar:J},mounted(){},setup(){const e=w(),n=function(){e.commit("setShowSearchState",!1)};return{showSearch:k(()=>e.state.showSearch),showMenu:k(()=>e.state.showMenu),menu:k(()=>e.state.menu),clickSearchModalMask:n}}});function Te(e,n,t,a,o,s){const r=u("Layout"),c=u("searchModal"),d=u("r-modal"),p=u("SideBar"),g=u("r-scroll-bar");return l(),h(y,null,[m(r),m(d,{class:"search-overlayer",show:e.showSearch,"onUpdate:show":n[0]||(n[0]=P=>e.showSearch=P),onClickMask:e.clickSearchModalMask,bodyOverflow:!1},{default:v(()=>[m(c)]),_:1},8,["show","onClickMask"]),e.showMenu?(l(),D(g,{key:0,class:"block md:hidden fixed right-0 top-[3.8rem] bottom-0 bg-white shadow-sm"},{default:v(()=>[m(p,{menu:e.menu},null,8,["menu"])]),_:1})):O("",!0)],64)}var ze=b(Je,[["render",Te]]),T={weight:{"\u6307\u5357/\u4ECB\u7ECD":99999,"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B":99998,\u6307\u5357:99999},defaultPage:"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md"};const E=[];let j=E,S=null;function Ke(e,n){if(e.length>0)for(let t=0;t<e.length;t++){const a=e[t];if(a.title===n)return a}return null}function Ue(e){const n=e.replace("/docs/","").split("/");n.splice(n.length-1,1,n[n.length-1].split(".").slice(0,-1).join("."));for(let t=0;t<n.length;t++){const a=n[t],o=Ke(j,a);if(!o){const s=S?[...S.link,a]:[a],r={title:a,link:s,weight:T.weight[s.join("/")]||0};j.push(r),t<n.length-1&&(r.children=[],j=r.children,S=r),t===n.length-1&&(r.path=x(e));continue}o&&t<n.length-1&&(o.children||(o.children=[]),j=o.children,S=o)}return j=E,S=null,n}function Xe(e,n){let t=[{path:"/",redirect:x(`../docs/${T.defaultPage}`)}];for(const o in e){const s=Ue(x(o,!1));t.push({path:x(o),component:()=>new Promise((r,c)=>{e[o]().then(d=>{r(d.default);const p=sessionStorage.getItem("md-heading-map"),g=p?JSON.parse(p):{};g[x(o)]=d.headings,sessionStorage.setItem("md-heading-map",JSON.stringify(g))})}),meta:{menuPath:s.length>0?s.join(","):s[0]}}),n&&Array.isArray(n)&&n.length>0&&(t=[...t,...n])}const a=function(o){o.forEach(s=>{s.children&&a(s.children)}),o.sort((s,r)=>r.weight-s.weight)};return a(E),{Router:X({history:Z(),routes:t,scrollBehavior(o,s,r){return{el:`#${o.query.p}`,top:70}}}),routes:t,menu:E}}var Ze=[{name:"electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE",content:`<p><img src="./electron.jpg" alt="\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE"></p>
