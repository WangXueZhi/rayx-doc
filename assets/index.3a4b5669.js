import{d as g,u as x,a as E,r as M,b as h,c as u,e as l,f as m,w as j,p as H,g as L,o as p,F as f,h as A,t as w,i as P,n as C,j as J,k as V,l as T,m as z,q as K,s as U,N as B,v as X,x as Z,R as G}from"./vendor.5022afda.js";const Q=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}};Q();const Y="modulepreload",D={},ee="./",_=function(t,n){return!n||n.length===0?t():Promise.all(n.map(a=>{if(a=`${ee}${a}`,a in D)return;D[a]=!0;const r=a.endsWith(".css"),o=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${o}`))return;const s=document.createElement("link");if(s.rel=r?"stylesheet":Y,r||(s.as="script",s.crossOrigin=""),s.href=a,document.head.appendChild(s),r)return new Promise((c,i)=>{s.addEventListener("load",c),s.addEventListener("error",i)})})).then(()=>t())};function v(e,t=!0){const n=e.split("/").map(a=>t?encodeURIComponent(a):a);return n[0].includes(".")&&n.splice(0,1,""),n.join("/")}var y=(e,t)=>{for(const[n,a]of t)e[n]=a;return e};const ne=g({name:"layout-search-modal",mounted(){},setup(){const e=x(),t=E(),n=M({searchRes:[]});return{goPage:function(o,s){t.push(v(o)+(s||"")),e.commit("setShowSearchState",!1)},searchInput:function(o){n.searchRes=[],o&&e.state.docsData.forEach(s=>{s.name.includes(o)&&n.searchRes.push({data:s,isPageName:!0,pageName:s.name,matchHtml:`<div>${s.name.replace(o,`<span style="color: var(--main-color)">${o}</span>`)}</div>`,searchValue:o}),s.keyWords.forEach(c=>{c.indexOf(o)>=0&&n.searchRes.push({data:s,isPageName:!1,pageName:s.name,matchHtml:`<div>${c.replace(o,`<span style="color: var(--main-color)">${o}</span>`)}</div>`,searchValue:o,matchContent:c})})})},state:n}}}),N=e=>(H("data-v-a6e73884"),e=e(),L(),e),te={class:"search-modal"},oe={class:"search-input"},se={class:"search-scroll"},re=["onClick"],ae=["innerHTML"],ce=["onClick"],ie=N(()=>l("div",{class:"search-scroll-item-left"},"#",-1)),de={class:"search-scroll-item-content"},le=["innerHTML"],pe={class:"search-scroll-item-content-heading"},ue=N(()=>l("div",{class:"tips"},"\u6309 esc \u9000\u51FA",-1));function he(e,t,n,a,r,o){const s=h("r-icon"),c=h("r-input"),i=h("r-scroll-bar");return p(),u("div",te,[l("div",oe,[m(c,{size:"big",onInput:e.searchInput,autofocus:""},{prefix:j(()=>[m(s,{name:"iconicon-test7"})]),_:1},8,["onInput"])]),l("div",se,[m(i,{class:"search-scroll-wrapper"},{default:j(()=>[l("div",null,[(p(!0),u(f,null,A(e.state.searchRes,(d,k)=>(p(),u("div",{key:k},[d.isPageName?(p(),u("div",{key:0,class:"search-scroll-item",onClick:F=>e.goPage(d.data.url.slice(1))},[m(s,{name:"iconform",size:20,class:"search-scroll-item-left"}),l("div",{innerHTML:d.matchHtml,class:"search-scroll-item-content search-scroll-item-mainText"},null,8,ae)],8,re)):(p(),u("div",{key:1,class:"search-scroll-item",onClick:F=>e.goPage(`${d.data.url.slice(1)}`,`?p=${d.matchContent}`)},[ie,l("div",de,[l("div",{innerHTML:d.matchHtml,class:"search-scroll-item-mainText"},null,8,le),l("div",pe,w(d.data.name),1)])],8,ce))]))),128))])]),_:1})]),ue])}var me=y(ne,[["render",he],["__scopeId","data-v-a6e73884"]]);const _e=g({name:"layout-menu",props:{menu:{type:Array,default:()=>[]},level:{type:Number,default:0}},setup:()=>{const e=x(),t=E();return{activeRoutPath:P(()=>e.state.activeRoutPath),itemClick:n=>{n.children&&n.children.length>0||n.path&&t.push(n.path)}}}}),ge={class:"layout-menu-item-name layout-menu-item-hasChildren"},fe=["onClick"];function ve(e,t,n,a,r,o){const s=h("layout-menu");return p(!0),u(f,null,A(e.menu,c=>(p(),u("div",{class:C([`layout-menu-item-${e.level}`]),key:c.path},[c.children&&c.children.length>0?(p(),u(f,{key:0},[l("div",ge,w(c.title),1),m(s,{menu:c.children,level:e.level+1},null,8,["menu","level"])],64)):(p(),u("div",{key:1,class:C(["layout-menu-item-name layout-menu-item-noChildren",{"layout-menu-item-active":c.path===e.activeRoutPath}]),onClick:i=>e.itemClick(c)},w(c.title),11,fe))],2))),128)}var ye=y(_e,[["render",ve],["__scopeId","data-v-710ccf2a"]]);const ke=g({name:"layout-content",setup(){const e=J(),t=E(),n=M({headingNav:[],path:e.path,moreHeading:!1}),a=function(){};return V(()=>e.path,async o=>{n.path=o;const s=sessionStorage.getItem("md-heading-map");if(s){const i=JSON.parse(s)[e.path];n.headingNav=i}}),{state:n,goHeading:function(o){t.push(n.path+"?p="+o.text)},switchHeading:a}}}),xe={class:"layout-content"},je={class:"layout-heading-menu-wrapper"},be=["onClick"];function $e(e,t,n,a,r,o){const s=h("router-view"),c=h("r-scroll-bar");return p(),u("div",xe,[m(s),e.state.headingNav.length>0?(p(),T(c,{key:0,class:C(["layout-heading-menu",{"layout-heading-menu-moreHeading":e.state.moreHeading}])},{default:j(()=>[l("div",je,[(p(!0),u(f,null,A(e.state.headingNav,(i,d)=>(p(),u("div",{key:d,class:"layout-heading-menu-item",onClick:k=>e.goHeading(i)},w(i.text),9,be))),128))])]),_:1},8,["class"])):z("",!0)])}var we=y(ke,[["render",$e],["__scopeId","data-v-6d653c58"]]);const qe=g({name:"layout-head",setup:()=>{const e=x(),t=function(){e.commit("setShowSearchState",!0)};return document.addEventListener("keydown",n=>{n.ctrlKey&&n.key=="k"&&(e.commit("setShowSearchState",!0),n.preventDefault()),n.key=="Escape"&&(e.commit("setShowSearchState",!1),n.preventDefault())}),{show:t}}}),O=e=>(H("data-v-7afe9c69"),e=e(),L(),e),Se={class:"layout-head"},Ee=O(()=>l("div",{class:"project-name"},"RayxDoc - \u65B9\u4FBF\u56E2\u961F\u5FEB\u901F\u642D\u5EFA\u7684\u8F7B\u91CF\u6587\u6863\u7CFB\u7EDF",-1)),Ae={class:"head-right"},Pe=O(()=>l("span",{class:"head-right-search-text"},"Search",-1));function Ce(e,t,n,a,r,o){const s=h("r-icon");return p(),u("div",Se,[Ee,l("div",Ae,[l("div",{class:"head-right-search",onClick:t[0]||(t[0]=(...c)=>e.show&&e.show(...c))},[m(s,{name:"iconicon-test7",class:"demo-icon"}),Pe])])])}var Ie=y(qe,[["render",Ce],["__scopeId","data-v-7afe9c69"]]);const Re=g({name:"Layout",components:{Menu:ye,Content:we,Head:Ie},setup(){const e=x();return{menu:P(()=>e.state.menu)}}}),Me={class:"layout-menu-wrapper"};function He(e,t,n,a,r,o){const s=h("Head"),c=h("Menu"),i=h("r-scroll-bar"),d=h("Content");return p(),u(f,null,[m(s),m(i,{class:"layout-menu"},{default:j(()=>[l("div",Me,[m(c,{menu:e.menu},null,8,["menu"])])]),_:1}),m(d)],64)}var Le=y(Re,[["render",He],["__scopeId","data-v-cefde80c"]]);const Be=g({name:"App",components:{Layout:Le,searchModal:me},mounted(){},setup(){const e=x(),t=function(){e.commit("setShowSearchState",!1)};return{showSearch:P(()=>e.state.showSearch),clickSearchModalMask:t}}});function De(e,t,n,a,r,o){const s=h("Layout"),c=h("searchModal"),i=h("r-modal");return p(),u(f,null,[m(s),m(i,{show:e.showSearch,"onUpdate:show":t[0]||(t[0]=d=>e.showSearch=d),onClickMask:e.clickSearchModalMask,bodyOverflow:!1},{default:j(()=>[m(c)]),_:1},8,["show","onClickMask"])],64)}var Ne=y(Be,[["render",De]]),W={weight:{"\u6307\u5357/\u4ECB\u7ECD":99999,"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B":99998,\u6307\u5357:99999},defaultPage:"\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md"};const q=[];let b=q,$=null;function Oe(e,t){if(e.length>0)for(let n=0;n<e.length;n++){const a=e[n];if(a.title===t)return a}return null}function We(e){const t=e.replace("/docs/","").split("/");t.splice(t.length-1,1,t[t.length-1].split(".").slice(0,-1).join("."));for(let n=0;n<t.length;n++){const a=t[n],r=Oe(b,a);if(!r){const o=$?[...$.link,a]:[a],s={title:a,link:o,weight:W.weight[o.join("/")]||0};b.push(s),n<t.length-1&&(s.children=[],b=s.children,$=s),n===t.length-1&&(s.path=v(e));continue}r&&n<t.length-1&&(r.children||(r.children=[]),b=r.children,$=r)}return b=q,$=null,t}function Fe(e,t){let n=[{path:"/",redirect:v(`../docs/${W.defaultPage}`)}];for(const r in e){const o=We(v(r,!1));n.push({path:v(r),component:()=>new Promise((s,c)=>{e[r]().then(i=>{s(i.default);const d=sessionStorage.getItem("md-heading-map"),k=d?JSON.parse(d):{};k[v(r)]=i.headings,sessionStorage.setItem("md-heading-map",JSON.stringify(k))})}),meta:{menuPath:o.length>0?o.join(","):o[0]}}),t&&Array.isArray(t)&&t.length>0&&(n=[...n,...t])}const a=function(r){r.forEach(o=>{o.children&&a(o.children)}),r.sort((o,s)=>s.weight-o.weight)};return a(q),{Router:K({history:U(),routes:n,scrollBehavior(r,o,s){return{el:`#${r.query.p}`,top:70}}}),routes:n,menu:q}}var Je=[{name:"electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE",content:`<p><img src="./electron.jpg" alt="\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE"></p>
...
`,url:"./docs/\u6307\u5357/\u83DC\u5355\u987A\u5E8F\u63A7\u5236.md",keyWords:["\u83DC\u5355\u987A\u5E8F\u63A7\u5236"]}];const Ve={"../docs/Electron/electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE.md":()=>_(()=>import("./electron\u9879\u76EE\u57FA\u672C\u67B6\u6784\u56FE.611ec0ed.js"),[]),"../docs/Linux/\u5B9A\u65F6\u66F4\u65B0svn.md":()=>_(()=>import("./\u5B9A\u65F6\u66F4\u65B0svn.b6d9623f.js"),[]),"../docs/Node/mock\u670D\u52A1.md":()=>_(()=>import("./mock\u670D\u52A1.fed3aa63.js"),[]),"../docs/Node/pnpm.md":()=>_(()=>import("./pnpm.fe0ee120.js"),["assets/pnpm.fe0ee120.js","assets/vendor.5022afda.js"]),"../docs/\u6253\u5305\u5DE5\u5177/vite.md":()=>_(()=>import("./vite.0fbd93a4.js"),["assets/vite.0fbd93a4.js","assets/vendor.5022afda.js"]),"../docs/\u6307\u5357/Mermaid.md":()=>_(()=>import("./Mermaid.733880a0.js"),["assets/Mermaid.733880a0.js","assets/vendor.5022afda.js"]),"../docs/\u6307\u5357/\u4ECB\u7ECD.md":()=>_(()=>import("./\u4ECB\u7ECD.091515ac.js"),[]),"../docs/\u6307\u5357/\u56FE\u7247\u8D44\u6E90.md":()=>_(()=>import("./\u56FE\u7247\u8D44\u6E90.d5ccd543.js"),[]),"../docs/\u6307\u5357/\u5FEB\u901F\u4E0A\u624B.md":()=>_(()=>import("./\u5FEB\u901F\u4E0A\u624B.d695eeaf.js"),[]),"../docs/\u6307\u5357/\u83DC\u5355\u987A\u5E8F\u63A7\u5236.md":()=>_(()=>import("./\u83DC\u5355\u987A\u5E8F\u63A7\u5236.5f5f0faa.js"),[]),"../docs/\u6253\u5305\u5DE5\u5177/webpack/require.context.md":()=>_(()=>import("./require.context.6c1f51a8.js"),["assets/require.context.6c1f51a8.js","assets/vendor.5022afda.js"])},{Router:I,routes:Ke,menu:Te}=Fe(Ve);I.beforeEach((e,t,n)=>{B.start(),R.commit("setActiveDocPath",e.meta.menuPath),R.commit("setActiveRoutPath",e.path),n()});I.afterEach(()=>{B.done()});const R=X({state(){return{menu:Te,activeDocPath:"",docsData:Je,showSearch:!1,activeRoutPath:""}},mutations:{setActiveDocPath(e,t){e.activeDocPath=t},setShowSearchState(e,t){e.showSearch=t},setActiveRoutPath(e,t){e.activeRoutPath=t}}}),S=Z(Ne);S.use(G);S.use(I);S.use(R);S.mount("#app");export{_};
